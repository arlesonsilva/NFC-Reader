var app = {
		...
		if (device.platform == "Android") {
			...
			nfc.addMimeTypeListener( 
				...
				function (status) { // listener successfully initialized
					...
					nfc.removeMimeTypeListener("text/plain", app.offNfc, null, null);
	...
	*/
	...
	/*
	          Process NDEF tag data from the nfcEvent
	*/
	offNfc: function(nfcEvent) {
		app.clear(); // clear the message div
		
		// display the event type:
		app.showTag("Remove o listener de eventos registrado anteriormente adicionado via nfc.addMimeTypeListener."); // display the tag details
